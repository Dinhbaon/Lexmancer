...
{
	/// <summary>
	/// Auto-generated unique identifier from database (integer primary key)
	/// Not included in JSON - assigned by database on insert
	/// </summary>
	[JsonIgnore]
	...
	/// Empty for base elements, [1, 2] for Steam, etc.
	/// </summary>
	[JsonPropertyName("recipe")]
	public List<int> Recipe { get; set; } = new();
	...
	{
		// ID is auto-generated by database, don't validate here
	...
	public string GetRecipeKey()
	{
		...
		var sorted = new List<int>(Recipe);
		sorted.Sort();
